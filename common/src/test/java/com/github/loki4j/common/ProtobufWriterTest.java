...
public class ProtobufWriterTest {
    ...
    public void testWriteRecords() throws IOException {
        var rec1 = create(1000, 0, "a=1,b=2", "TestMsg1");
        var rec2 = create(2000, 0, "a=1,b=2", "TestMsg2");
        var rec3 = create(3000, 0, "c=3,d=4", "TestMsg3");

        var expUncomp = PushRequest.newBuilder()
        ...
        var writer = new ProtobufWriter(1000);
